...
def run_inference(args: Dict):
    ...
    for img_path in tqdm(img_list):
        ...
        if restored_img is not None:
            ...
            if args.suffix is not None:
                save_restore_path = os.path.join(args.output, 'generated_frames', f'{basename}_{args.suffix}.{extension}')
            else:
                save_restore_path = os.path.join(args.output, 'generated_frames', f'{basename}.{extension}')
