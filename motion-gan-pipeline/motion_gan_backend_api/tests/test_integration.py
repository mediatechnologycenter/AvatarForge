...
from motion_gan_backend_api.app import app
from motion_gan_backend_api.tests.integration_test_client import AvatarIntegrationTestClient
...
class TestIntegration(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.client.wait_for_service_readiness(timeout=timedelta(minutes=15))
