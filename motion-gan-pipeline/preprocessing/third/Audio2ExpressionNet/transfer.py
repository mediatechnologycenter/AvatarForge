...
#            mapping = X.data
    ...
    os.makedirs(dataset_path+'/TRANSFERS/'+opt.name, exist_ok=True)
    list_transfer = open(dataset_path+'/TRANSFERS/'+opt.name+'/list_transfer.txt', "a")
    ...
    for source_actor in source_actors:
        ...
        out_dir = dataset_path+'/TRANSFERS/'+opt.name+'/'+source_name+'--'+target_name+'/expressions'
